...
// @raycast.title ! Create review task for GitHub Issue
//
...
if (
  ...
  console.error("No issue found from clipboard.");
  process.exit(0);
}
...
const result = runShellScript(`/usr/local/bin/gh issue view ${url}`);
